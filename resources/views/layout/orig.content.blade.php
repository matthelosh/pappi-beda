                        ...
                        <tbody>
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('coreui/assets/img/avatars/1.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('coreui/assets/img/avatars/2.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-danger"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('coreui/assets/img/avatars/3.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-warning"></span></div>
                            </td>
                            <td>
                              <div>Quintin Ed</div>
                              <div class="small text-muted"><span>New</span> | Registered: Jan 1, 2015</div>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('coreui/assets/img/avatars/4.jpg" alt="user@email.com') }}"><span class="c-avatar-status bg-secondary"></span></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            <td class="text-center">
                              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('coreui/assets/img/avatars/5.jpg') }}" alt="user@email.com"><span class="c-avatar-status bg-success"></span></div>
                            </td>
                            <td>
