<header class="c-header c-header-light c-header-fixed c-header-with-subheader">
        ...
        <ul class="c-header-nav ml-auto mr-4">
          ...
          <li class="c-header-nav-item dropdown"><a class="c-header-nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false" title="{{ Auth::user()->nama }}">
              <div class="c-avatar"><img class="c-avatar-img" src="{{ asset('/storage/img/'.AUth::user()->sekolah_id.'_'.Auth::user()->nip.'.jpg') }}" alt="user@email.com" onerror="this.onerror=null;this.src='/img/users/{{ (Auth::user()->jk == 'l') ? 'guru_l.png' : 'guru_p.png' }}'"></div>
            </a>
