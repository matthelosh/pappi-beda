      ...
      <div class="row justify-content-center">
        <div class="col-md-8">
          <div class="card-group">
              ...
              <div class="card-body">
                ...
                <form action="/login" method="post">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input class="form-control" type="text" name="nisn" placeholder="NISN" value="{{ (Session::get('_old_input')) ? Session::get('_old_input')['username'] : '' }}">
                  </div>
                  @error('password')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
            ...
            <div class="card text-white py-5 d-md-down-none" style="width:44%;background: #c75b5b!important;">
              <div class="card-body text-center">
                <div>
                  <img src="{{ asset('img/favicon.png') }}" alt="Logo Pappi" width="100px" style="position:relative;">
                  <h2>JARONAH</h2>
                  <p>Belajar Online dari Rumah</p>
                </div>
              </div>
            </div>
          </div>
